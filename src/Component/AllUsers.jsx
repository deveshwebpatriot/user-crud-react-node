...
const AllUsers = () => {
    ...
    const searchHandler = () => {
        axios.get(`http://localhost:8080/serach/${search}`).then((res) => {
                    ...
                    {/* {[...users].reverse().map((user) => ( */}
                        ...
                        {users.map((user) => (
                            <TRow key={user._id}>
                                ...
                                <TableCell>
                                    <Button color="success" variant="contained" style={{ marginRight: 5 }} component={Link} to={`/edit/${user._id}`}>Edit</Button>
